...
const upcomingCards: UpcomingCard[] = [
  {
    ...
    imageUrl:
      "https://theme.bitspecksolutions.com/html-template/listright/demo/assets/images/event-1.jpg",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1.25em"
  ...
  },
  {
    ...
    imageUrl:
      "https://theme.bitspecksolutions.com/html-template/listright/demo/assets/images/event-2.jpg",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1.25em"
  ...
  },
  {
    ...
    imageUrl:
      "https://theme.bitspecksolutions.com/html-template/listright/demo/assets/images/event-3.jpg",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1.25em"
...
const categories = [
  {
    ...
    svg: (
      <svg
        className="w-10 h-10 text-orange-600 hover:text-white svg-icon"
        xmlns="http://www.w3.org/2000/svg"
        width="36"
        height="36"
        viewBox="0 0 36 36"
...
const blogs: Blog[] = [
  {
    ...
    category: "Music",
    description:
      "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dignissimos tempora magnam ratione hic officia enim, quidem...",
    detailsLink: "#",
    icons: {
      authorIcon: (
        <svg
...
const BlogCardsData: BlogCard[] = [
  {
    ...
    author: "Mark Harmisson",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissimos tempora magnam ratione hic officia enim.",
    date: "10 Oct, 2027",
    category: "Restaurant",
    imageUrl:
      "https://theme.bitspecksolutions.com/html-template/listright/demo/assets/images/restaurent-3.jpg",
    authorIcon: (
      ...
      >
        <path
          fill="currentColor"
          d="M12 12c2.7 0 4.86-2.16 4.86-4.86S14.7 2.28 12 2.28 7.14 4.44 7.14 7.14 9.3 12 12 12zm0 2.28c-3.24 0-9.72 1.62-9.72 4.86v1.62h19.44v-1.62c0-3.24-6.48-4.86-9.72-4.86z"
        />
      </svg>
    ),
    calendarIcon: (
      ...
      >
        <path
          fill="currentColor"
          d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 21c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H5V10h14v11z"
        />
      </svg>
    ),
    categoryIcon: (
      ...
      >
        <path
          fill="currentColor"
          d="M12 2a5 5 0 0 0-5 5v3H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V11a1 1 0 0 0-1-1h-3V7a5 5 0 0 0-5-5Zm0 2a3 3 0 0 1 3 3v3H9V7a3 3 0 0 1 3-3ZM6 12h12v8H6v-8Zm4 2v4h2v-4h-2Zm4 0v4h2v-4h-2Z"
        />
      </svg>
    ),
  },
...
const listingcards: ListingCard[] = [
  {
    ...
    heartIcon: (
      ...
      >
        <path
          fill="currentColor"
          d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5A5.48 5.48 0 0 1 7.5 3C9.24 3 11 4.4 11.25 4.71A5.454 5.454 0 0 1 16.5 3C19.54 3 22 5.44 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35Z"
        />
      </svg>
    ),
  },
