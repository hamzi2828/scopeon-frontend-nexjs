...
const BannerSection: React.FC = () => {
    ...
    return (
        <div id="Banner-Section" className="flex flex-col items-center justify-center w-100 min-h-screen text-white relative mx-5 xl:mx-0">
            <h1 className="lg:text-7xl text-5xl lg:font-medium mb-4">Explore This Amazing City</h1>
            <p className="mb-8 lg:text-xl text-lg">Find the perfect place to hangout in your city from over 1258 listings</p>
            <div className="bg-[#00000033] py-4 px-2 rounded-sm shadow-lg max-w-screen-xl w-full mx-20">
                <div className="bg-white shadow-lg md:flex hidden w-full mx-auto">
                    <div className="relative inline-block text-left w-1/5">
                        ...
                        <div
                            className={`${isOpen ? 'block' : 'hidden'} origin-top-right absolute right-0 w-full shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10`}
                        >
                            <div className="py-1">
                ...
                <div className="w-full max-w-md mx-auto md:hidden block">
                    ...
                    <div className="mt-4">
                        <button className="w-full bg-orange-600 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                            <svg 
