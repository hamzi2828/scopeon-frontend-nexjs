            ...
            <div className="p-4">
              ...
              <div className="mt-4 text-gray-700 space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <span>{listingcard.phone}</span>
                </div>
              </div>
              <div className="mt-4 flex items-center justify-between">
                <Link
                  href={`/listingdetail?id=${listingcard.id}`}
