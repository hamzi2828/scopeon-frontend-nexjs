...
// Define the types for listingCardData
...
const RecentViewedProducts: React.FC = () => {
  ...
  const handleRatingClick = (index: number, starIndex: number): void => {
    ...
    <div>
      <div className="max-w-screen-xl mx-auto py-4 ">
        <div className="flex justify-between">
          <h1 className="text-2xl">Recent Viewed Products</h1>
          <div className="relative w-1/5">
            ...
            >
              <div className="py-1">
                {["Restaurant", "Beauty & Spa", "Shopping", "Cafe", "Movie"].map((category, idx) => (
                  <span
                    key={idx}
                    className="block px-5 py-3 text-sm text-gray-700 hover:bg-orange-600 hover:text-white border-t border-black cursor-pointer"
                  >
                    {category}
                  </span>
                ))}
