...
import { FaUser, FaCalendarAlt, FaComments, FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram, FaPinterestP, FaThumbsUp, FaThumbsDown } from "react-icons/fa";
                ...
                <div className="p-4">
                    ...
                    <div className="bg-gray-100 p-4 mb-6">
                        <p className="text-2xl font-normal">
                            ...
                            aboriosam similique nam corporis optio animi, officia eos quas. Unde consequuntur aut.
                        </p>
                    </div>
                    <p className="text-gray-700 leading-relaxed mb-6">
                        Doloribus voluptates architecto recusandae, obcaecati praesentium voluptatem eligendi quas accusantium fuga soluta eius ducimus sed voluptatum?
                    </p>
                    <div className='h-96 mb-6'>
                        <img src="https://theme.bitspecksolutions.com/html-template/listright/demo/assets/images/event-2.jpg" alt="" className='w-full h-full object-cover rounded-lg' />
                    </div>
                    <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                        <div className="flex flex-col items-start">
                            <span className="font-bold mb-2">Tags</span>
                            <div className="flex flex-wrap gap-2">
                                <span className="bg-gray-100 text-gray-800 px-3 py-1 text-sm uppercase hover:text-white hover:bg-orange-500 duration-300 cursor-pointer rounded-full">Creative</span>
                                <span className="bg-gray-100 text-gray-800 px-3 py-1 text-sm uppercase hover:text-white hover:bg-orange-500 duration-300 cursor-pointer rounded-full">Digital</span>
                                <span className="bg-gray-100 text-gray-800 px-3 py-1 text-sm uppercase hover:text-white hover:bg-orange-500 duration-300 cursor-pointer rounded-full">Music</span>
                            </div>
                        </div>
                        <div className="flex flex-col items-end">
                            <span className="font-bold mb-2">Share</span>
                            <div className="flex gap-2">
                                <Link href="" className="text-gray-500 hover:text-orange-500 text-xl hover:translate-x-1 duration-300">
                                    <FaFacebookF />
                                </Link>
                                <Link href="" className="text-gray-500 hover:text-orange-500 text-xl hover:translate-x-1 duration-300">
                                    <FaTwitter />
                ...
                <div className="flex items-start p-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-700 mt-2 leading-relaxed">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus architecto eos fugiat.
                        </p>
